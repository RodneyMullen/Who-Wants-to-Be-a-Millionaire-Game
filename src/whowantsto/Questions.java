...
public class Questions 
{
    ...
    public Questions(String[] newquestioninstance)
    {
    ...
    public Questions(String new_question, String new_a_answer,String new_b_answer, String new_c_answer, String new_d_answer, String new_answer)
    {
