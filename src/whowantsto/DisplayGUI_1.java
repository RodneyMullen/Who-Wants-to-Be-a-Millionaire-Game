 ...
 * @author Rodney
 */
public class DisplayGUI_1 extends JPanel implements ActionListener,ItemListener
{
   ...
   //exits GUI 
    ...
    public void editPlayerOne(Player oldPlayer, WhoWantsTo currentWhoWantsTo)
    {
        ...
        EnterNameText.setFont(new Font("Copperplate Gothic", Font.BOLD, 28));
        ...
        NameEntry.setFont(new Font("Copperplate Gothic", Font.BOLD, 28));
    ...
    public void editMultiPlayerNames(Vector<String> names, WhoWantsTo WWT)
    {
        ...
        for(int i =0; i<Multiplayernames.size(); i++)
        {
            ...
            MultiPlayerNameEntry.setFont(new Font("Copperplate Gothic", Font.BOLD, 28));
    ...
    public void editAskAFriendTimeLimit(QuestionsBase Questionsbase_editable)
    {
        ...
        EditAskAFriendTimeLimitText.setFont(new Font("Copperplate Gothic", Font.BOLD, 26));
        ...
        EditAskAFriendTimeLimitEntry.setFont(new Font("Copperplate Gothic", Font.BOLD, 28));
	...
	Main_Panel.setOpaque(false);
       ...
       // Percentages_text.setFont(new Font("Copperplate Gothic Bold", Font.BOLD, 32));
            Percentages_text.setFont(new Font("Copperplate Gothic", Font.BOLD, 32));
    ...
    {   
        ...
        AskTheAudience_text.setFont(new Font("Copperplate Gothic", Font.BOLD, 16));
    ...
    public void showTimer(int count,WhoWantsTo CurrentWhoWantsTo)
    {
        ...
        Countdown.setFont(new Font("Copperplate Gothic", Font.BOLD, 56));
